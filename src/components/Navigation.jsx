...
const GlassNavigation = () => {
  ...
  return (
    <nav
      ...
      className="glass-nav bg-black fixed left-0 right-0 top-0 z-30 mx-auto max-w-6xl overflow-hidden border-[1px] border-white/10 bg-gradient-to-br from-white/20 to-white/5 backdrop-blur md:left-6 md:right-6 md:top-6 md:rounded-2xl"
    >
...
const Logo = () => (
  <span className=" relative left-0 top-[50%] z-10 text-4xl font-black text-white mix-blend-overlay md:absolute md:left-[50%] md:-translate-x-[50%] md:-translate-y-[50%]">
